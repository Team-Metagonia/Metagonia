...
public class FurColorMenu : CustomizationMenu
{
    ...
    public void ApplyRandomColor()
    {
        ...
        this.customCharacter.SetColor(this.customCharacter.beardMeshTransform, newColor);
        this.customCharacter.SetColor(this.customCharacter.moustacheMeshTransform, newColor);
    }
